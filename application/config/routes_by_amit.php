...
/* Start Folder Route */
$route['folders/deleteFolder'] = 'folders/deleteFolder';
$route['folders/create/folders/(:num)'] = 'folders/createFolders/$1';
$route['folders/create/folders'] = 'folders/createFolders';
//$route['folders/edit/folders/(:any)'] = 'folders/createFolders/$1';
//$route['folders/create/folders'] = 'folders/createFolders';
$route['folders/form/folders'] = 'folders/displayForm';
$route['folders/form/folders/(:any)'] = 'folders/displayForm/$1';
$route['folders/get/folders/(:any)'] = 'folders/getFolders/$1';
$route['folders/(:any)'] = 'folders/index/$1';

/* Start Files Route */
$route['files/deleteFolder'] = 'files/deleteFolder';
$route['files/create/files/(:num)'] = 'files/createFolders/$1';
$route['files/create/files'] = 'files/createFolders';
//$route['folders/edit/folders/(:any)'] = 'folders/createFolders/$1';
//$route['folders/create/folders'] = 'folders/createFolders';
$route['files/form/files'] = 'files/displayForm';
$route['files/form/files/(:any)'] = 'files/displayForm/$1';
$route['files/get/files/(:any)'] = 'files/getFiles/$1';
