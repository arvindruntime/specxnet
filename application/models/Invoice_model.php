...
Class Invoice_model extends CI_Model {
    ...
    public function getInvoicelist($select = '*',$where = array(),$order = null,$limit = null,$offset=null) {
        ...
        try {
            ...
            $this->db->join("proposal p", "i.fk_pid = p.p_id", "inner");
            ...
            $this->db->join('purchase_order po', 'i.fk_po_id = po.po_id', 'left');
