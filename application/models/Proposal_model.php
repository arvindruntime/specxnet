...
Class Proposal_model extends CI_Model {
    ...
    protected $tableNameProposalInvoice = 'invoice';
    protected $tableNameProposalPO = 'purchase_order';
    ...
    public function getProposallist($select = '*',$where = array(),$order = null,$limit = null,$offset=null) {
...
public function addPO($insertField) {

    
    try {

        $id = $this->db->insert($this->tableNameProposalPO,$insertField);
