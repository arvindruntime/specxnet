...
<?php } else { ?>
    <input type="hidden" id="p_id" value="<?php echo $p_id; ?>">
    <input type="hidden" id="lead_opportunity_id" value="<?php echo $proposal[0]['fk_lead_opportunity_id']; ?>">
    <div id="validation_errors_proposal"></div>
    <div class="form-group m-form__group row m--margin-top-20" style="width: 100%;">
        
        <div class="col-lg-8 col-md-8 col-sm-12">
            <p for="street_address" style="font-size: 14px; margin-left: 40px;margin-top: 20px;">Proposal Title - <strong><?php echo $proposal[0]['title']; ?></strong></p>
        </div>
        <?php if (isset($getItemList) && !empty($getItemList)) { ?>
        <div class="col-lg-4 col-md-4 col-sm-12" style="margin-top: 15px">
            <button type="button" id="approveButton" class="btn btn-primary" value="" style="height: 30px;padding: .45rem 1.15rem;float: right;margin-right: 10px;">Release Proposal ?</button>
        </div>
    <?php }?>
        
        <!-- <div class="col-lg-6 col-md-6 col-sm-12 padtop4">
                        ...
                        <div class="tab-pane active show" id="m_portlet_base_demo_16_tab_content" role="tabpanel">
                            ...
                            <div class="form-group m-form__group row" style="padding-top: 1rem;margin: 1px;padding-left: 10px;padding-right: 10px;">
                                <div id="tableList" style="width: 100%;">
                                    <p align="right"><strong>Total FOB: <?php echo isset($proposal[0]['total_fob'])?$proposal[0]['total_fob']:'N/A'; ?> | Total CIF: <?php echo isset($proposal[0]['total_cif'])?$proposal[0]['total_cif']:'N/A'; ?></strong></p>
                                    <table class="table table-bordered" id="itemTable">

                                   </table>
                                   <script type="text/javascript">
                                        var p_id = $("#p_id").val();
                                        datastring = {fk_pid : p_id};
                        ...
                        <div class="tab-pane" id="m_portlet_base_demo_17_tab_content" role="tabpanel">
                            <div class="form-group m-form__group row" style="padding-top: 1rem;margin: 1px;padding-left: 10px;padding-right: 10px;">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12" style="margin-bottom: 10px;">
                                    <textarea rows="5" cols="5" name="format_header" id="format_header" placeholder="Add Format Header Here..." style="width: 100%;margin-bottom: 10px"><?php echo isset($format['format_header'])?$format['format_header']:''; ?></textarea>
                                </div>

                                <div class="col-lg-12 col-md-12 col-sm-12"  style="margin-bottom: 10px;">
                                    <textarea rows="5" cols="5" name="format_footer" id="format_footer" placeholder="Add Format Footer Here..." style="width: 100%;margin-bottom: 10px"><?php echo isset($format['format_footer'])?$format['format_footer']:''; ?></textarea>
                                </div>
                                    ...
                                    <tr>
                                        <td colspan="4" align="center">
                                            <table class="table table-bordered">
                                                <thead>
                                                    <tr style="height: 32px;color: black;background-color: #d1cdcd;font-size: 13px">
                                                        <th>Sr No</th>
                                                        <th>Item</th>
                                                        <th>Item Code</th>
                                                        <th>Quanitity</th>
                                                        <th>Total Price (Ex Factory)</th>
                                                        <th>Fabric Quantity</th>
                                                        <th>Total Price (Fabric)</th>
                                                        <th>Leather Quantity</th>
                                                        <th>Total Price (Leather)</th>
                                                        <th>Total Price FOB</th>
                                                        <th>Total Price CIF</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                        if (isset($getItemList)) {
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $item['total_price_ex_factory']?></td>
                                                                    <td><?php echo $item['fabric_quantity']?></td>
                                                                    <td><?php echo $item['unit_total_price_fabric']?></td>
                                                                    <td><?php echo $item['leather_quantity']?></td>
                                                                    <td><?php echo $item['unit_total_price_leather']?></td>
                                                                    <td><?php echo $item['total_price_fob']?></td>
                                                                    <td><?php echo $item['total_price_cif']?></td>
                    ...
                    <div id="replaceItemForm">
                        <div class="modal-body"><div id="validation_errors_worksheet"></div>
                            <?php
                                if (isset($p_id)) {
                            ?>
                                <input type="hidden" id="fk_pid" name="fk_pid" value="<?php echo $p_id; ?>">
                        <?php } else {?>
