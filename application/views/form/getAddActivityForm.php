...
<input type="hidden" id="lopid" value="<?php echo $fk_lead_opportunity_id; ?>">
<div id="tableList">
    <table class="table table-bordered" id="activityTable">
    </table>
</div>
<script type="text/javascript">
    var lop_id = $("#lopid").val();
    datastring = {lead_opportunity_id : lop_id};
    table.activityPopupTable(datastring);
</script>
<?php } else {
    $userDetails = $contacts;
    $contacts = explode(',', $contacts[0]['user_info']);
    foreach ($contacts as $key => $value) {
        $newConString = explode('_', $value);
        if ($newConString[1] == 'Email') {
            $email[] = $newConString[0];
        } else {
            $phone[] = $newConString[0];
        }
    }
    //print_r($phoneNo);
...
<style type="text/css">
  ...
  background: #80808091;
        ...
        <div class="modal-content updateActivity modal__scroll" id="addLeadActivity">
            <div class="form-group m-form__group row m--margin-top-20" style="padding-left: 18px !important;">
                <div class="col-lg-9 col-md-9 col-sm-12">
                    <h4 id="oppTitle"><?php echo isset($opportunity_title)?$opportunity_title:''; ?></h4>
                    <input type="hidden" name="fk_lead_opportunity_id" id="fk_lead_opportunity_id" value="<?php echo isset($fk_lead_opportunity_id)?$fk_lead_opportunity_id:''; ?>">
                                        ...
                                        <div class="tab-pane active show" id="m_portlet_base_demo_8_tab_content" role="tabpanel">
                                                    ...
                                                    <select class="form-control" name="initiated_byUpdate" id="initiated_byUpdate" style="height: 38px !important" required>
                                                        ...
                                                        <?php
                                                            if (isset($salesPerson)) {
                                                                ...
                                                                <option value="<?php echo $Salesperson['user_id'];?>" <?php if (isset($value['initiated_by']) && $value['initiated_by'] == $Salesperson['user_id']) { echo "selected";} else if ($Salesperson['user_id'] == $this->session->userdata('user_id')) { echo "selected"; }?> > <?php echo $Salesperson['name'];?></option>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                    ...
                                                    <select class="form-control" name="assigned_by" id="assigned_byUpdate" style="height: 38px !important" required>
                                                        ...
                                                        <?php
                                                            if (isset($salesPerson)) {
                                                                foreach ($salesPerson as $Salesperson) { ?>
                                                                <option value="<?php echo $Salesperson['user_id'];?>" <?php if (isset($value['assigned_by']) && $value['assigned_by'] == $Salesperson['user_id']) { echo "selected";}  else if ($Salesperson['user_id'] == $this->session->userdata('user_id')) { echo "selected"; }?> > <?php echo $Salesperson['name'];?></option>
                                            ...
                                            <div class="form-group m-form__group row m--margin-top-20">
                                                <div class="col-lg-5 col-md-4 col-sm-12">
                                                    ...
                                                    ?>
                                                        <input class="form-control m-input" style="width: 100%;" id="datepickerUpdte" type="datetime-local" name="activity_start_datetime" placeholder="eg: 23-Oct-2019" value="<?php echo isset($value['activity_start_datetime'])?$value['activity_start_datetime']:$currentDate; ?>" required>
                                                ...
                                                <div class="col-lg-5 col-md-4 col-sm-12">
                                                    ...
                                                    <?php
                                                     //if(isset($value['activity_date']) ) {
                                                    ?>
                                                        <input class="form-control m-input" placeholder="eg: 23-Oct-2019" style="width: 100%;" id="datepicker" type="datetime-local" name="activity_end_datetime" value="<?php echo isset($value['activity_end_datetime'])?$value['activity_end_datetime']:$afterTime; ?>" required>
                                            ...
                                            <div class="form-group m-form__group row m--margin-top-20">
                                                ...
                                                <div class="col-lg-5 col-md-5 col-sm-12" id="followUp" disabled style="display: none;">
                                                    <label for="street_address">Follow up Date & Time</label>
                                                    <input class="form-control m-input" style="width: 100%;" type="datetime-local" name="follow_up_datetime" placeholder="eg: 23-Oct-2019" value="<?php echo isset($value['activity_end_datetime'])?$value['activity_end_datetime']:''; ?>">
                                                </div>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12" id="drafttime" disabled style="display: none;">
                                                    ...
                                                    <input class="form-control m-input" style="width: 100%;" type="datetime-local" id="email_draft_time" name="email_draft_time" placeholder="eg: 23-Oct-2019" value="<?php echo isset($value['activity_end_datetime'])?$value['activity_end_datetime']:''; ?>">
                                                </div>
                                            </div>

                                            <div class="form-group m-form__group row m--margin-top-20">
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <label for="street_address"><span style="color:red;">* </span>Add Note</label>
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12"  id="descriptionField" style="margin-top: 10px;display: none">
                                                    ...
                                                    <textarea class="form-control m-input" name="description" id="description" placeholder="" rows="3" style="height:150px!important"><?php echo isset($value['description'])?$value['description']:''; ?></textarea>
                                                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12">
                    <h3>Customer Info</h3>
                    <label>
                        <b>Name: </b><span id="attachFullname"><?php echo isset($userDetails[0]['full_name'])?$userDetails[0]['full_name']:'---'; ?></span>
                        <input type="hidden" name="userName" value="<?php echo isset($userDetails[0]['full_name'])?$userDetails[0]['full_name']:'---'; ?>">
                    </label><br/>
                    <label>
                        <b>Company: </b><span id="attachCompany"><?php echo isset($userDetails[0]['company_name'])?$userDetails[0]['company_name']:'---'; ?></span>
                    </label><br/>
                    <label>
                        <b>Designation: </b><span id="attachDesignation"><?php echo isset($userDetails[0]['designation'])?$userDetails[0]['designation']:'---'; ?></span>
                    </label><br/>
                    <label>
                        <b>Phone: </b><span id="attachPhone"><?php echo isset($phone)?implode(' | ', $phone):'---'; ?></span>
                    </label>
                    <label>
                        <b>Email: </b><span id="attachEmail"><?php echo isset($email)?implode(' | ', $email):'---'; ?></span>
                        <input type="hidden" name="userEmail" value="<?php echo isset($phone)?implode(' | ', $phone):'---'; ?>">
                    </label>
                </div>
