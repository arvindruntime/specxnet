    ...
    <div class="m-accordion m-accordion--default m-accordion--solid m-accordion--section  m-accordion--toggle-arrow" id="m_accordion_7" role="tablist">
                        ...
                        <div class="tab-pane active show" id="m_portlet_base_demo_11_tab_content" role="tabpanel">
                            ...
                            <div class="form-group m-form__group row m--margin-top-20 padtop3">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    ...
                                    <input type="text" name="pemail" onkeyup="getEmailList(this.value)" value="<?php echo isset($value['pemail'])?$value['pemail']:''; ?>" id="pemail" class="form-control m-input" required>
                                    <p id="emailText"></p>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    <label for="street_address"><?php if (!isset($value['last_name'])) { echo "<span style='color: red'>* </span>";}?>Primary Phone</label>
                                    <input type="text" name="pphone" onkeyup="changeColor('pphone',this.value)" value="<?php echo isset($value['pphone'])?$value['pphone']:''; ?>" id="pphone" class="form-control m-input" required>
                                </div>
                            </div>
                            <div class="form-group m-form__group row m--margin-top-20 padtop3">
                                <div id="leadDetailsExist"> </div>
                            ...
                            <div class="form-group m-form__group row m--margin-top-20 padtop3">
                                <div class="col-lg-4 col-md-4 col-sm-12">
                                    ...
                                    <input type="text" list="datalist" class="form-control m-input" id="LeadusrComp" placeholder="Select Company" name="Leaduser_comp_id" onkeyup="changeColor('company',this.value)" value="<?php echo isset($value['company_name'])?$value['company_name']:''; ?>" onchange="selectCompany(this.value, '<?php echo 'customer'; ?>')" required>
        ...
        <div class="form-group m-form__group row m--margin-top-20 padtop3">
            <div class="col-md-6 col-sm-6 col-3">
                ...
                <span style="font-size: 15px">Check To Add Lead Opportunity Details</span>
            </div>
        </div>
        <div id="leadSection"  class="m-portlet m-portlet--tabs" <?php if(isset($value['lead_opportunity_id']) && $value['lead_opportunity_id']!='') { ?>style="display: block;" <?php } else { ?> style="display: none;" <?php }?>>
            <div class="form-group m-form__group row padtop3" style="padding-top: 15px;">
                <div class="col-lg-5 col-md-12 col-sm-12">
                    <label for="street_address"><span style="color:red;">* </span>  Opportunity Title</label>
            ...
            <div class="form-group m-form__group row">
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <label for="recipient-name" class="form-control-label">Confidence:</label>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <label for="recipient-name" class="form-control-label">Projected Sales Date:</label>
                    <div class="input-group date" id="opportunity_project" >
                        <?php
                            if(isset($value['projected_sales_date']) ) {
                            ?>
                        <!-- <input type="text" class="form-control m-input datepicker" name="follow_up_date" value="<?php echo isset($value['projected_sales_date'])?date('d/M/Y',strtotime($value['projected_sales_date'])):''; ?>"> -->
                        <!-- <input type="date" class="form-control m-input datepicker" name="follow_up_date" value="<?php echo isset($value['projected_sales_date'])?$value['projected_sales_date']:''; ?>"> -->
                        ...
                        ?>
                        <!-- <input type="datex" class="form-control m-input datepicker" name="follow_up_date"> -->
                ...
                <div class="col-lg-4 col-md-4 col-sm-12" style="margin-top: -14px;">
                    <label class="col-form-label"><span style="color:red;">* </span>Sales Person</label>
        ...
        <div class="form-group m-form__group row m--margin-top-20">
            <div class="col-lg-12 col-md-12 col-sm-12">
                ...
                <input class="form-control m-input" type="text" name="activity_title" onkeyup="changeColor('addNote',this.value)" value="<?php echo isset($value['activity_title'])?$value['activity_title']:''; ?>" required>
            </div>
