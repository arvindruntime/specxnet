                                    ...
                                    <div id="replaceFilter">
                                        ...
                                        <div class="form-group m-form__group row" style="padding: 1rem; margin-bottom:0">
                                            ...
                                            <div class="col-lg-2 col-md-2 col-sm-3">
                                                ...
                                                <!-- <input type="text" name="approval_deadline" id="approval_deadline" class="form-control m-input" placeholder="Approval Deadline" value="<?php echo isset($getFilterData['approval_deadline'])?$getFilterData['approval_deadline']:''; ?>"> -->
...
<script>
    ...
    window.moduleType = "<?php echo "analysis"; ?>";
