                ...
                <div class="modal-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tr align="center">
                            ...
                            <td><input type="checkbox" name="internal" value="Proposal Title"></td>
                        ...
                        <tr align="center">
                            ...
                            <td><input type="checkbox" name="internal" value="Opportunity Title"></td>
                        ...
                        <tr align="center">
                            ...
                            <th>Sales Person</th>
                            <td><input type="checkbox" name="internal" value="Sales Person"></td>
                        ...
                        <tr align="center">
                            ...
                            <td><input type="checkbox" name="internal" value="Approval Deadline"></td>
                        ...
                        <tr align="center">
                            ...
                            <td><input type="checkbox" name="internal" value="Total Price(Ex-Factory)"></td>

                        </tr>

                        <tr align="center">

                            <th>Total Price(Fabrics)</th>
                            <td><input type="checkbox" name="internal" value="Total Price(Fabrics)"></td>
                        ...
                        <tr align="center">
                            ...
                            <td><input type="checkbox" name="internal" value="Total Price(Leather)"></td>
                        ...
                        <tr align="center">
                            ...
                            <td><input type="checkbox" name="internal" value="Proposal Status"></td>

                        </tr>

                        <tr align="center">

                            <th><b>Save For Future</b><input type="checkbox" name="ischeck" id="ischeck"></th>
                            <td><input type="text" name="saveGrid" id="saveGrid" disabled="true" required="" /></td>
                        ...
                        <tr>
                            ...
                            <th></th>
                            <td><input type="button" value="Submit" onclick="createGridTable()"></td>
...
<div class="modal fade" id="PO_Template" role="dialog" aria-labelledby="" aria-hidden="true" style="display: none;">
...
<div id="purchase_order_template"></div>
