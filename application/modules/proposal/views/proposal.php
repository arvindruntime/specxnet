...
<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
    ...
    <div class="m-grid__item m-grid__item--fluid m-wrapper">
        ...
        <div style="margin-bottom: 0.5rem;">
            <div class="d-flex align-items-center">
                <div class="mr-auto margin_left"></div>
            </div>
        </div>
                    ...
                    <form action="<?php echo base_url();?>proposal" method="post" class="m-form m-form--fit m-form--label-align-right" id="getFilter">
                        <div id="replaceFilter">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-3">
                                ...
                                <?php if(isset($getFilterData['approval_deadline']) && $getFilterData['approval_deadline'] != '') { ?>
    ...
    <div class="m-portlet m-portlet--tabs">
        ...
        <div class="m-portlet__body3">
            <div class="col-md-12 no-padding">
                <table class="table table-striped- table-bordered table-hover table-checkable" id="datatable"></table>
            </div>
        </div>
    </div>
    <!--end: Datatable -->
