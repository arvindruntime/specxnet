...
<input type="hidden" name="fk_pw_id" id="fk_pw_id" value="<?php echo isset($fk_pw_id) ? $fk_pw_id : ''; ?>">
<input type="hidden" name="fk_po_id" id="fk_po_id" value="<?php echo isset($po_id) ? $po_id : ''; ?>">
    ...
    <div class="form-group m-form__group row m--margin-top-20">
        <?php if (isset($value['title']) && $value['title'] != '') { ?>
            <div class="col-lg-6 col-md-6 col-sm-12">
                <p for="street_address mob-m-left-20" style="font-size: 14px; margin-left: 40px;margin-top: 20px;"><strong><?php echo $value['title']; ?></strong></p>
            </div>
        ...
        <?php } else { ?>
            <div class="col-lg-6 col-md-6 col-sm-12">
                <label for="street_address"><span style="color:red;">* </span>Proposal For </label>
            ...
            <div class="col-lg-3 col-md-3 col-sm-12 padtop4">
                <label for="street_address">Company Name</label>
        ...
        <div class="col-lg-3 col-md-3 col-sm-12 padtop4">
            ...
            <div class="input-group date">
                ...
                ?>
                    <input type="datetime-local" class="form-control m-input datepicker" name="approval_deadline" id="approval_date" value="<?php echo isset($value['approval_deadline']) ? $value['approval_deadline'] : ''; ?>">
                <?php } else { ?>
                    <input type="datetime-local" class="form-control m-input datepicker" name="approval_deadline" id="approval_date" value="">
                <?php } ?>
            </div>
        </div>
    </div>
    ...
    <div class="form-group m-form__group row m--margin-top-20">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <?php if (isset($p_id)) { ?>
                ...
                <button class="btn btn-outline-primary m-btn m-btn--custom" id="saveProposal">Save</button>
            <?php } else { ?>
                <p>Check If you want to Add Worksheet data : <input type="checkbox" id="checkWorkshhet" /></p>
            <?php } ?>
            <a type="button" href="<?php echo base_url() ?>upload/sampleItemList.xlsx" class="btn btn-default m-btn m-btn--custom">Download Sample Excel</a>
        </div>
    </div>
    <div class="modal-body">
        <div class="m-portlet m-portlet--tabs" id="showUL" style="<?php if (!isset($p_id)) { echo "display:none;"; } ?>">
            ...
            <div class="m-portlet__body margin-top2" style="">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active show" id="m_portlet_base_demo_16_tab_content" role="tabpanel">
                        <button type="button" id="addButton" class="btn btn-success active" data-toggle="modal" data-target="#addmodal" style="height: 30px;padding: .45rem 1.15rem;">Add</button>
                        <div class="form-group m-form__group row" style="padding-top: 1rem;margin: 1px;padding-left: 10px;padding-right: 10px;">
                            <div id="tableList" style="width: 100%;">
                                ...
                                <table class="table table-bordered" id="itemTable"></table>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane" id="m_portlet_base_demo_17_tab_content" role="tabpanel">
                        <div class="form-group m-form__group row" style="padding-top: 1rem;margin: 1px;padding-left: 10px;padding-right: 10px;">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <button class="btn btn-success" id="add_format">
                                    <?php if (isset($format['pf_id']) && $format['pf_id'] != '') { echo 'Update Format'; } else { echo 'Add Format'; } ?>
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane" id="m_portlet_base_demo_18_tab_content" role="tabpanel">
                        ...
                        <div class="form-group m-form__group row" id="printdiv" style="padding-top: 1rem; margin: 1px; width: 100%; overflow-x: auto; "></div>
                    </div>
                                ...
                                <form enctype="multipart/form-data" method="post" id="excelUpload" onsubmit="excelUpload()">
                                    <div class="modal-body">
                                        ...
                                        <div class="" style="display:inline;">
                                            <input type="hidden" name="redirectAction" value="<?php echo isset($redirectAction) ? $redirectAction : ''; ?>">
...
<?php } else { ?>
    <input type="hidden" name="fk_pid" id="fk_pid" value="<?php echo isset($p_id) ? $p_id : ''; ?>">
    <input type="hidden" name="customer" id="customer" value="<?php echo $value['approved_by_customer']?>">
    <div class="form-group m-form__group row m--margin-top-20">
        <div class="col-lg-6 col-md-6 col-sm-12 mob-m-left-20" style="font-size: 14px; margin-left: 40px;margin-top: 20px;">
        ...
        <input type="hidden" name="lead_opportunity_id" id="lead_opportunity_id" value="<?php echo isset($value['lead_opportunity_id']) ? $value['lead_opportunity_id'] : ''; ?>">
        <div id="getCompanyOpportunity"></div>
        <div class="col-lg-3 col-md-3 col-sm-12 padtop4 mob-m-left-20">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 padtop4 mob-m-left-20" style="font-size: 14px; margin-left: 40px;margin-top: 20px;">
    ...
    <div class="modal-body">
        <div class="m-portlet m-portlet--tabs" id="showUL" style="<?php if (!isset($p_id)) { echo "display:none"; } ?>;">
            ...
            <div class="m-portlet__body margin-top2" style="">
                <div class="tab-content">
                    <div class="tab-pane active show" id="m_portlet_base_demo_16_tab_content" role="tabpanel">
                        <div class="form-group m-form__group" style="padding-top: 1rem; margin: 1px;padding-left: 10px;padding-right: 10px;">
                            <div id="tableList" style="width: 100%;">
                                <!-- <p align="right"><strong>Total FOB: <?php echo isset($getFobCif[0]['fob']) ? '$ ' . $getFobCif[0]['fob'] : 'N/A'; ?> | Total CIF: <?php echo isset($getFobCif[0]['cif']) ? '$ ' . $getFobCif[0]['cif'] : 'N/A'; ?></strong></p> -->
                                <table class="table table-bordered" id="itemTable"></table>
                            </div>
                    ...
                    <div class="tab-pane" id="m_portlet_base_demo_17_tab_content" role="tabpanel"></div>
                    <div class="tab-pane" id="m_portlet_base_demo_18_tab_content" role="tabpanel">
                        <button type="button" class="btn btn-success active" onclick="printDiv()" style="height: 30px;padding: .45rem 1.15rem;float: right;">Print</button>
                        <div class="form-group m-form__group" id="printdiv" style="padding-top: 1rem; margin: 1px; width: 100%; overflow-x: auto;"></div>
                    </div>
                    <div class="tab-pane" id="m_portlet_base_demo_19_tab_content" role="tabpanel">
                        <div class="form-group m-form__group row" style="padding-right: 10px;">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <form class="m-form m-form--fit m-form--label-align-right" enctype="multipart/form-data" onsubmit="AddComment()" method="post">
                        <div class="modal-body" style="position: relative; overflow-y: auto;  max-height: 400px;  padding: 15px;">
                            ...
                            <div class="" style="display:inline;">
                                ...
                                <input type="hidden" name="module" value="Proposal">
                                <input type="hidden" name="fk_pid" value="<?php echo isset($p_id) ? $p_id : ''; ?>">
                                <button type="submit"  class="btn btn-info m-btn m-btn--custom">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="modal fade" id="recordNo-modal" role="dialog" aria-labelledby="" aria-hidden="true">
            <div class="modal-dialog modal-sm" style="max-width: 80%;" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form class="m-form m-form--fit m-form--label-align-right" enctype="multipart/form-data" onsubmit="AddRecordNo()" method="post">
                        <div class="modal-body" style="position: relative; overflow-y: auto;  max-height: 400px;  padding: 15px;">
                            <div id="commentMsg"></div>
                            <div class="form-group m-form__group row m--margin-top-20 import-excel-margin">
                                <label for="record_no" id="record_label"></label>
                                <div class="custom-file">
                                    <input type="text" name="record_no" id="record_no" rows="6" style="width: 700px!important; height: 35px!important;"></textarea>
                                </div>
                            </div>
                            <div class="" style="display:inline;">
                                <input type="hidden" name="commentRecordStatus" id="commentRecordStatus" value="">
                                <input type="hidden" name="module" value="Proposal">
                                <input type="hidden" name="fk_pid" value="<?php echo isset($p_id) ? $p_id : ''; ?>">
                                <button type="submit"  class="btn btn-info m-btn m-btn--custom">Submit</button>
                            </div>
