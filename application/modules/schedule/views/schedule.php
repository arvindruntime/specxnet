            ...
            <div class="m-portlet m-portlet--mobile">
                ...
                <div class="m-portlet m-portlet--tabs">
                    ...
                    <div class="m-portlet__head">
                        ...
                        <div class="m-portlet__head-tools">
                            ...
                            <ul class="nav nav-tabs m-tabs-line m-tabs-line--success m-tabs-line--2x" role="tablist" style="margin-top: 15px">
                                ...
                                <?php foreach($actionButton as $row) { ?>

                                    <li class="nav-item m-tabs__item black-height">

                                        <a class="nav-link m-tabs__link black-pad <?php if(isset($module_type) && $module_type == $row['name']) { echo "active show";}?>" href="<?php echo base_url($row['link']); ?>">

                                            <i class="fa fa-calendar-check-o" aria-hidden="true"></i> <?php echo ucFirst($row['name']); ?> 
                    ...
                    <div class="m-portlet__body3">
                        ...
                        <div class="col-md-12 mob-top-pad-50">
                        ...
                        <div class="col-md-12" id="GanttChartDIV">
