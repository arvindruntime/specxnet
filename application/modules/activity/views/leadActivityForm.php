...
if (isset($values['activity_type'])) {
    ...
    $lead_activity_id = $values['lead_activity_id'];
    ...
    $activity_start_datetime = $values['activity_start_datetime'];

    $activity_end_datetime = $values['activity_end_datetime'];

    $reminder = $values['reminder'];

    $las = $values['lead_activity_status'];
...
<style type="text/css">
  ...
  background: #80808091;
    ...
    <div class="modal-content snehal" id="selectLeadOpp" style="display: inline;">
            ...
            <div class="modal-body" style="height: 250px; overflow-y: scroll;">
                ...
                <div class="form-group m-form__group row m--margin-top-20">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <!-- <select class="form-control m-select2" id="selecLeadOpportinutyadd" name="param" style="opacity: 1;">
                            ...
                            <?php
                                ...
                                foreach($getLead as $title) { ?>
                                    ...
                                    <option value="<?php echo $title['lead_opportunity_id'],":",$title['email'],":",$title['phone'],":",$title['full_name'],":",$title['designation'],":",$title['company_name'],":",$title['opportunity_title'],":",$title['lead_opportunity_id'];?>"><?php echo $title['opportunity_title'];?></option>
                        ...
                        <input type="text" list="datalist" class="form-control m-input" placeholder="Select Lead Opportunity" id="selecLeadOpportinutyadd" name="param" onchange="selectOpportunity(this.value)">
                        ...
                        <option value="<?php echo $value['opportunity_title'].' - '.$title['full_name'];?>"></option>
        ...
        <div class="modal-content updateActivity modal__scroll" id="addLeadActivity" style="display: none;">

            <div class="form-group m-form__group row m--margin-top-20" style="padding-left: 18px !important;">

                <div class="col-lg-9 col-md-9 col-sm-12">

                    <h4 id="oppTitle">Opportunity Type: <?php echo isset($opportunity_title)?ucwords($opportunity_title):''; ?></h4>
                                        ...
                                        <div class="tab-pane active show" id="m_portlet_base_demo_8_tab_content" role="tabpanel">
                                            ...
                                            <div class="form-group m-form__group row m--margin-top-20">
                                                    ...
                                                    <select class="form-control" name="initiated_byUpdate" id="initiated_byUpdate" style="height: 38px !important" required>
                                                        ...
                                                        <?php
                                                            ...
                                                            if (isset($salesPerson)) {
                                                                ...
                                                                <option value="<?php echo $Salesperson['user_id'];?>" <?php if (isset($initiated_by) && $initiated_by == $Salesperson['user_id']) { echo "selected";} ?> > <?php echo $Salesperson['name'];?></option>
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12">
                                                    ...
                                                    <select class="form-control" name="assigned_by" id="assigned_byUpdate" style="height: 38px !important" required>
                                                        ...
                                                        <?php  if (isset($salesPerson)) {

                                                                foreach ($salesPerson as $Salesperson) { ?>

                                                                <option value="<?php echo $Salesperson['user_id'];?>" <?php if (isset($assigned_by) && $assigned_by == $Salesperson['user_id']) { echo "selected";}?> > <?php echo $Salesperson['name'];?></option>
                                            ...
                                            <div class="form-group m-form__group row m--margin-top-20">
                                                ...
                                                <div class="col-lg-4 col-md-4 col-sm-12" id="activityStatus">
                                                    ...
                                                    <?php if (isset($activity_type) && $activity_type == 'Phone Call') { 
                                                       ...
                                                       <?php }
                                                        ...
                                                        <?php foreach ($get_activity_status as $key => $activity_status_value) {
                                                            ...
                                                            if ($activity_status_value['activity_type'] == $activity_type) {
                                            ...
                                            <div class="form-group m-form__group row m--margin-top-20">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    ...
                                                    <input class="form-control m-input" type="text" name="activity_title" value="<?php echo isset($activity_title)?$activity_title:''; ?>" required>
                ...
                <div class="col-lg-3 col-md-3 col-sm-12">
                    ...
                    <label>
                        ...
                        <b>Name: </b><span id="attachFullname"><?php echo isset($values['full_name'])?$values['full_name']:'---'; ?></span>

                        <input type="hidden" name="userName" value="<?php echo isset($values['full_name'])?$values['full_name']:'---'; ?>">

                    </label><br/>

                    <label>

                        <b>Company: </b><span id="attachCompany"><?php echo isset($values['company_name'])?$values['company_name']:'---'; ?></span>

                    </label><br/>

                    <label>

                        <b>Designation: </b><span id="attachDesignation"><?php echo isset($values['designation'])?$values['designation']:'---'; ?></span>

                    </label><br/>

                    <label>

                        <b>Phone: </b><span id="attachPhone"><?php echo isset($values['phone'])?$values['phone']:'---'; ?></span>

                    </label>

                    <label>

                        <b>Email: </b><span id="attachEmail"><?php echo isset($values['email'])?$values['email']:'---'; ?></span>

                        <input type="hidden" name="userEmail" value="<?php echo isset($values['email'])?$values['email']:'---'; ?>">
