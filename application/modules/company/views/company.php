                                            ...
                                            <div class="col-lg-2 col-md-4 col-sm-4">
                                                ...
                                                <div class="m-portlet__nav-item">
                                                    ...
                                                    <div>
                                                        ...
                                                        <select class="form-control greyborder"  data-live-search="true" id="filter_parent_company_id" name="filter[parent_company]">

                                                            <option data-tokens="Menu1" value="">--Select Parent Company--</option>
                                                            ...
                                                            <option value="<?php echo $parent['company_id'];?>" <?php if (isset($filter['parent_company']) && $filter['parent_company']==$parent['company_id']) { echo "selected";}?> ><?php echo $parent['company_name'];?></option>
...
<script>
    ...
    window.companyType = "<?php echo $companyType; ?>";

    window.moduleType = "<?php echo "company"; ?>";
    ...
    window.industry = '<?php echo $industry; ?>';
