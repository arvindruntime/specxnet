$(document).ready(function() {
  ...
  table.url = window.baseUrl+'folders/get/folders/'+window.folderType+window.customeFilter;
	...
	table.columnDefs =  [
      ...
      "orderable": false
		...
		{
			"render": function ( data, type, row ) {
    			return '<a href="#" class="edit-company" data-url="'+window.baseUrl+'folders/form/'+window.folderType+'/'+row.folder_id+'" data-toggle="modal" data-target="#modal"><img src="'+window.baseUrl+'/upload/folder_open.png" height="20px" width="20px"> '+data+'</a>';
			},
			"targets": 1
		}	
    ];
