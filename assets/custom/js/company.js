$(document).ready(function() {
	$(".row tab-top-margin").addClass("mob-m-top-80");
    table.url = window.baseUrl + 'company/get/companies/' + window.companyType + window.customeFilter;
        ...
        table.columnDefs = [
...

            {
                ...
                "render": function(data, type, row) {
                    ...
                    return '<a href="#" class="edit-company" data-url="' + window.baseUrl + 'company/form/' + window.companyType + '/' + row.company_id + '" data-toggle="modal" data-target="#modal">' + data + '</a>';
    ...
    $('#exportExcel').click(function() {
        ...
        if (rest == '') {
            ...
            window.location.href = window.baseUrl + 'company/createExcel/' + window.companyType + '/' + rest;
        ...
        $(document).on('change', '#checkedAction', function(e)

            {
                ...
                if (fst == "delete") {
                    ...
                    var answer = confirm("Are you sure you want to delete record!                                                NOTE: If this is a parent company, child company will also get deleted");

                    ajax.url = window.baseUrl + 'company/deleteCompany';
...
function deleteCompanyProfileFile(val) {
    ...
    if (res) {
        ...
        $.ajax({
            ...
            url: "company/deleteAttachCompanyProfileFile",
            ...
            success: function(data) {
                ...
                $('#replaceCompanyProfile').html(data);
...
function deleteCatalogFile(val) {
