$(document).ready(function() {
  table.url = window.baseUrl+'warranty/get/'+window.customeFilter;
	...
	table.columnDefs =  [
      ...
      "orderable": false
		...
		{
			"render": function ( data, type, row ) {
    			return '<a href="#" class="edit-company" data-url="'+window.baseUrl+'warranty/form/'+row.id+'" data-toggle="modal" data-target="#modal">'+data+'</a>';
			},
			"targets": 1
		}	
    ];
