$(document).ready(function() {
    ...
    table.url = window.baseUrl + 'invoice/get/list/' + window.customeFilter;
        ...
        table.columnDefs = [
...

            {
                ...
                "render": function(data, type, row) {
                    ...
                    return '<a href="#" class="edit-proposal" data-url="' + window.baseUrl + 'invoice/get_InvoicePreview/' + row.p_id + '" data-toggle="modal" data-target="#modal" data-id="' + row.p_id + '">' + data + '</a>';
