$(document).ready(function() {
    ...
    table.url = window.baseUrl + 'purchase_order/get/list/' + window.customeFilter;
        ...
        table.columnDefs = [
...

            {
                ...
                "render": function(data, type, row) {
                    ...
                    return '<a href="#" class="edit-proposal" data-url="' + window.baseUrl + 'purchase_order/get_POpreview/' + row.p_id + '" data-toggle="modal" data-target="#modal" data-id="' + row.p_id + '">' + data + '</a>';

                    // } else {

                    // return '<a href="#" class="edit-proposal" data-url="' + window.baseUrl + 'purchase_order/form/' + row.p_id + '" data-toggle="modal" data-target="#modal" data-id="' + row.p_id + '">' + data + '</a>';
...
//         url: "purchase_order/get_POpreview/" + fk_pid,
...
//     check = confirm("Are you sure, you want to approve this Proposal ?");
...
//             url: window.baseUrl + "Proposal/set/status/Approved",
...
$(document).on('click', '#approveProposal', function(e) {
    ...
    //         $('#comment-modal').modal('toggle'); //or  $('#IDModal').modal('hide');
    //         return false;
...
//     check = confirm("Are you sure, you want to decline this Proposal ?");
...
//             url: window.baseUrl + "Proposal/set/status/Declined",
...
$(document).on('click', '#declineProposal', function(e) {
    // var fk_pid = $("#fk_pid").val();
    // datastring = 'fk_pid=' + fk_pid + '&status=Declined';
...
$(document).on('click', '#releasePO', function(e) {
    ...
    check = confirm("Are you sure, you want  to release PO ?");

    if (check) {
        $("#commentStatus").val('Release PO');
        $('#comment-modal').modal('show');
    }
...
$(document).on('click', '#releaseInvoice', function(e) {
    ...
    check = confirm("Are you sure, you want to release Invoice ?");

    if (check) {
        $("#commentStatus").val('Release Invoice');
        $('#comment-modal').modal('show');
    }
...
//             url: window.baseUrl+"Proposal/set/status/Released",
